...
class OllamaPDFSummarizer:
    def __init__(self, base_url: str = "http://77.37.45.138:11434"):
...
def main():
    ...
    with st.sidebar:
        ...
        ollama_host = st.text_input("Ollama Host:", value="http://77.37.45.138:11434", help="Set to the reachable Ollama host (default points to global IP)")
        ...
        if summarizer.check_ollama_connection():
            ...
            **Troubleshooting:**
            ...
            2. Check if accessible: `curl http://77.37.45.138:11434/api/tags`
